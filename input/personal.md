---
title: Hobbies and trivia about myself
---

## {{ hl("media", "Media") }}

- 🎵 Music: [vEnhance on Spotify](https://open.spotify.com/user/31ligpcn22uiybn6wwrfrouklsxq/playlists)
- 📺 Anime: [My Anime List](https://myanimelist.net/animelist/vEnhance)
- 💭 Webcomics: [Calvin and Hobbes](https://www.gocomics.com/calvinandhobbes/),
...
See the dedicated [Puzzle hunts](puzzlehunt.html) page.

## Games

See the dedicated [Games](games.html) page.
...
- [List of plushies](plushies.html)
