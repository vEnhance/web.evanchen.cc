...
\begin{abstract}
	This is adapted from \url{http://usamo.wordpress.com/tag/set-theory/}.
	For more on set theory, you might see my course notes from Math 145: \url{http://www.mit.edu/~evanchen/coursework.html}.
\end{abstract}
