...
PYTHONWARNINGS="ignore" gsutil -m rsync -r \
...
PYTHONWARNINGS="ignore" gsutil -m setmeta -h 'Cache-Control:private, max-age=0, no-transform' "gs://web.evanchen.cc/handouts/**"
