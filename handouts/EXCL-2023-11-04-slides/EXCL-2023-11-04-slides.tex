...
\subtitle{\url{https://web.evanchen.cc/coaches.html}}
...
\begin{frame}
  ...
  \begin{exampleblock}{Resolution}
    \begin{itemize}
      \ii \href{https://blog.evanchen.cc/points/}{Point-based problem sets},
...
\begin{frame}
  ...
  \begin{exampleblock}{Resolution}
    \begin{itemize}
      ...
      (\href{https://blog.evanchen.cc/usemo-dev/}{submit problems
      by X, ratings by Y, test chosen by Z}).
