...
\begin{quote}
  ...
  Instead of carrying many little objects detachedly, which could be embarrassing, we put them all in a bag,
  and then we have only one object to carry, the bag. \\ --- George P\'olya
\end{quote}
...
\begin{thebibliography}{9}
  ...
  \bibitem{ref:linear} \textbf{IMOmath: Recurrence Equations}, by Milan Novakovi\'c.
    \url{https://imomath.com/index.cgi?page=recursiveEquations}
  \bibitem{ref:imo} \textbf{IMOmath: The Method of Snake Oil}, by Milan Novakovi\'c.
    \url{https://imomath.com/index.cgi?page=methodOfSnakeOil}
\end{thebibliography}
