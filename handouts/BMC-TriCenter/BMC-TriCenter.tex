...
\setcounter{game}{-1}
\usepackage{multicol}
\lhead{Nine-Point Circle}
\lhead{Berkeley Math Circle}
...
\begin{multicols}{2}
	...
	\begin{center}
		\begin{asy}
			...
			draw(A--D(midpoint(B--C)), dashed);
			draw(B--D(midpoint(C--A)), dashed);
			draw(C--D(midpoint(A--B)), dashed);
		\end{asy}
	\end{center}
...
\begin{center}
	\begin{asy}
		...
		pair[] K = IPs(incircle(A,B,C),
			L(Mc-(M-I)*dir(90), Mc+(M-I)*dir(90)));
		pair K1 = K[1];
		pair K2 = K[0];
