...
\author{
  ...
  I can be reached at \href{mailto:evan@evanchen.cc}{evan@evanchen.cc}.}
  }
\date{July 13, 2012}
...
\include{content/ch_prelim}
\include{content/ch_basic}
\include{content/ch_tech1}
\include{content/ch_tech2}
\include{content/ch_example}
\include{content/ch_exer}
\include{content/ch_mop}

\appendix
\include{content/ch_append}
\include{content/ch_bib}
