...
\begin{lemma}
  \label{thm:trilemma}
  Let $a \ge b \ge c$ be the sides of a triangle.
  Then $S_a(b-c)^2 + S_b(c-a)^2 + S_c(a-b)^2$ is nonnegative whenever
...
\begin{thebibliography}{99}
  \bibitem{sos} Pham Kim Hung, \textit{Sums of Squares}.
    \url{https://www.aops.com/community/c55h80127}.
  ...
  \bibitem{mildorf} Thomas Mildorf, \textit{Olympiad Inequalities}.
    \url{https://www.aops.com/Resources/Papers/MildorfInequalities.pdf}.
\end{thebibliography}
