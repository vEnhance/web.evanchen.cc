...
\titlespacing*{\subsection}{4pt}{15pt}{4pt}
...
\begin{fasy}
import olympiad; import cse5; size(7cm); real lsf=0.9001; real lisf=2011.0; defaultpen(fontsize(8pt));
...
pair Q = IntersectionPoint(w,c,1);
pair P = IntersectionPoint(w,b,1);
...
\begin{fasy}
	import graph; size(8.01cm); real lsf=0.5; pathpen=linewidth(0.7); pointpen=black; pen fp=fontsize(10); pointfontpen=fp; real xmin=-4,xmax=4.01,ymin=-2.29,ymax=2.29;
...
\begin{figure}[t]
	\centering
	\begin{asy}
import olympiad; import cse5; size(6cm); real lsf=0.9001; real lisf=2011.0; defaultpen(fontsize(10pt));
