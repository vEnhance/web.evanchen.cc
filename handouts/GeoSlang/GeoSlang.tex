...
\begin{proof}
  ...
  but you can see a synthetic proof in British MO 2012 on AOPS \cite{BMO12}.
\end{proof}
...
\begin{thebibliography}{MSC21}
\bibitem[BCOG12]{BCOG12}
  Evan Chen and Max Schindler.
  \emph{Barycentric Coordinates on Olympiad Geometry.}
  \url{https://web.evanchen.cc/handouts/bary/bary-full.pdf}.

\bibitem[BMO12]{BMO12}
  Art of Problem Solving thread for \textit{British MO 2012}, 2012.
